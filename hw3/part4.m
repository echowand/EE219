...
for j = [0, 0.01, 0.1, 1]
    ...
    %    disp(['result of k = %0.0d and lambda = %0.2d', k(i), j]);
        [U,V,numIter,tElapsed,finalResidual(i)]=wnmfruleWeight(R,k(i),W,option);
...
for lambda = [0.01, 0.1, 1]
    ...
    for cross_validation = 1:10
        ...
        for idx=1:3
          [U,V,numIter,tElapsed,finalResidual]=wnmfruleWeight(R,k(idx),W,option);
          UV = U*V;
          sum_errors = 0;
